    ...
    const result = await pool.query(
      `INSERT INTO events (name, date, location, description, imageUrl)
       VALUES
         ...
         ('Fall of Constantinople', '1453-05-29 00:00:00', 'Istanbul', 'The Ottoman Empire captured Constantinople, ending the Byzantine Empire.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Benjamin-Constant-The_Entry_of_Mahomet_II_into_Constantinople-1876.jpg/800px-Benjamin-Constant-The_Entry_of_Mahomet_II_into_Constantinople-1876.jpg'),
